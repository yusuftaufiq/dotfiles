...
pkill -f "conky -d -c $USER_HOME_DIR/.config/conky/conky_normal.conf"
...
then
  ...
  gsettings set org.gnome.desktop.background picture-uri "file://$USER_HOME_DIR/.wallpapers/hifumi_togo.png"
